...
class YarnPalette():
    ...
    def change_yarn_colour(self, yarn_index, yarn_lock):
        yarn = self.yarns[yarn_index]
        if not yarn_lock:
...
class Window(QMainWindow):
    ...
    def design_yarn_frame(self):
        ...
        for yarn in self.yarnpalette.yarns:
            ...
            yarn.clicked.connect(
                lambda checked=yarn.isChecked(), x=yarn.index: self.yarn_clicked(x, self.yarnpalette.yarn_lock))
    ...
    def yarn_clicked(self, x, yarn_lock):
        self.yarnpalette.change_yarn_colour(x, yarn_lock)
        self.loom.change_warp_colour(self.yarnpalette.yarns[x])
